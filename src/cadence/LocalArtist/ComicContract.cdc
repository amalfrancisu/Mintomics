...
pub contract ExampleNFT {
    ...
    pub resource NFT {
        ...
        init(initID: UInt64, metadata1 : {String : String}) {
            self.id = initID
 ...
 //       pub fun printMetadata(id: UInt64): {String : String}
...
//        }
    ...
    pub resource NFTMinter {
        ...
        pub fun mintNFT(data : String): @NFT {

            // create a new NFT
            var newNFT <- create NFT(initID: self.idCount, metadata1: {"value" : data})
